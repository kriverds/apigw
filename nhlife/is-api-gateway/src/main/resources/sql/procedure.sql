...
BEGIN
	...
	FROM (
			SELECT 
				...
				,a.N_TALK_ACD_0 AS Answer10s -- ,[Answer10s]
				,a.N_TALK_ACD_1 AS Answer20s -- ,[Answer20s]
	...
	FROM (
			SELECT
			     ...
			     , CASE WHEN S.ROW_WEEK = '일요일' THEN '1' 
                  ...
                  , N_TALK_ACD_0 AS Answer10s  
                  , N_TALK_ACD_1 AS Answer20s  
                  , N_TALK_ACD_2 AS Answer30s  
                  , N_TALK_ACD_3 AS Answer40s  
                  , N_TALK_ACD_4 AS Answer50s  
                  , N_TALK_ACD_5 AS Answer60s  
                  , N_TALK_ACD_6 AS Answer120s 
                  , N_TALK_ACD_7 AS Answer180s 
                  , N_TALK_ACD_8 AS Answer300s 
