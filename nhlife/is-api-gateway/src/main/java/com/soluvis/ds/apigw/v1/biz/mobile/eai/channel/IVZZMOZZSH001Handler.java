package com.soluvis.ds.apigw.v1.biz.mobile.eai.channel;
...
/**
 * @Class 		: IVZZMOZZSH001Handler
 * @date   		: 2025. 2. 17.
 * @author   	: PA2412013
 * ----------------------------------------
 * @notify
 *  IVZZMOZZSH001 전문 핸들러
 * 
...
@Component
@Scope("prototype")
public class IVZZMOZZSH001Handler extends CommonEaiClientHandler{
	
	static final Logger logger = LoggerFactory.getLogger(IVZZMOZZSH001Handler.class);
	
	/**
	 * 스프링 DI
	 */
	MobileEaiRepository mobileEaiRepository;
	public IVZZMOZZSH001Handler(MobileEaiRepository mobileEaiRepository) {
